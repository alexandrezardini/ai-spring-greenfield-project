...
description: 'Java and Spring Boot backend best-practice guidance for planning or implementing backend features, APIs, services, persistence, transactions, validation, security, configuration, observability, or tests in Java Spring Boot codebases. Use when the task involves designing, changing, reviewing, or debugging backend Java/Spring Boot application code or architecture. Do not use for frontend-only work, documentation-only edits, CI/deployment changes that do not affect Java/Spring Boot behavior, generic Java questions outside Spring Boot, non-Java backend stacks, or simple repository navigation/status tasks.'
---
...
Load this skill on demand when planning, implementing, reviewing, or debugging backend features that touch Java and Spring Boot application behavior.

Do not load it for frontend-only tasks, documentation-only changes, infrastructure-only changes, repository housekeeping, or non-Spring Java work unless the task also requires Spring Boot backend design or code changes.
